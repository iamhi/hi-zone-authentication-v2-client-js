...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://api.ibeenhi.com/hi-zone-api/authentication-v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://api.ibeenhi.com/hi-zone-api/authentication-v2
         */
        ...
        this.authentications = {
            'hi-zone-authentication-v2': {type: 'bearer'}
        }
