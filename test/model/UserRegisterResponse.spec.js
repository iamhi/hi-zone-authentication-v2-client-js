...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HiZoneAuthenticationV2Api.UserRegisterResponse();
  });
  ...
  describe('UserRegisterResponse', function() {
    it('should create an instance of UserRegisterResponse', function() {
      // uncomment below and update the code to test UserRegisterResponse
      //var instance = new HiZoneAuthenticationV2Api.UserRegisterResponse();
      //expect(instance).to.be.a(HiZoneAuthenticationV2Api.UserRegisterResponse);
    });
