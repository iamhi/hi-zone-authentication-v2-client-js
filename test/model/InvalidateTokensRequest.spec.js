...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HiZoneAuthenticationV2Api.InvalidateTokensRequest();
  });
  ...
  describe('InvalidateTokensRequest', function() {
    it('should create an instance of InvalidateTokensRequest', function() {
      // uncomment below and update the code to test InvalidateTokensRequest
      //var instance = new HiZoneAuthenticationV2Api.InvalidateTokensRequest();
      //expect(instance).to.be.a(HiZoneAuthenticationV2Api.InvalidateTokensRequest);
    });
