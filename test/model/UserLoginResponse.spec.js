...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HiZoneAuthenticationV2Api.UserLoginResponse();
  });
  ...
  describe('UserLoginResponse', function() {
    it('should create an instance of UserLoginResponse', function() {
      // uncomment below and update the code to test UserLoginResponse
      //var instance = new HiZoneAuthenticationV2Api.UserLoginResponse();
      //expect(instance).to.be.a(HiZoneAuthenticationV2Api.UserLoginResponse);
    });
